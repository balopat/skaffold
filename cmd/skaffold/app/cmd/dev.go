...
func NewCmdDev(out io.Writer) *cobra.Command {
	...
	return NewCmd(out, cmdUse).
		...
		WithFlags(func(f *pflag.FlagSet) {
			f.StringVar(&opts.BuildTrigger, "build-trigger", "polling", "How are changes detected? (polling, notify, manual, or api)")
			f.StringVar(&opts.DeployTrigger, "deploy-trigger", "polling", "How are changes detected? (polling, notify, manual, or api)")
			f.StringVar(&opts.SyncTrigger, "sync-trigger", "polling", "How are changes detected? (polling, notify, manual, or api)")
